...
const Footer = () => {
    return (
        <footer className="bg-[#0a1120] text-gray-300 py-12 px-6 md:px-16">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-3">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-orange-500 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <span>123 Summer Street, Beach City, CA 90210</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-sm opacity-70">Stay connected for exclusive summer deals and updates!</p>
                    </div>
                </div>
